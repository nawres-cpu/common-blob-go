...
func (mc *MinIOCloudStorage) Attributes(ctx context.Context, key string) (*commonblobgo.Attributes, error) {
...
func (mc *MinIOCloudStorage) GetSignedURL(ctx context.Context, key string, opts *commonblobgo.SignedURLOption) (string, error) {
	reqParams := make(map[string]string)
	if opts != nil {
		if opts.Method != "" {
			reqParams["response-content-disposition"] = "attachment; filename=\"" + key + "\""
		}
	}
...
func (mc *MinIOCloudStorage) GetWriter(ctx context.Context, key string) io.WriteCloser {
	return nil
}

// ListWithOptions implements CloudStorage.
func (mc *MinIOCloudStorage) ListWithOptions(ctx context.Context, options *commonblobgo.ListOptions) *commonblobgo.ListIterator {
