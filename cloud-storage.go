...
cloudStorageOpts := CloudStorageOption{
    MinIOEndpoint:        "localhost:9000",
    MinIOAccessKeyID:     "minioadmin",
    MinIOSecretAccessKey: "minioadmin",
    MinIOBucketName:      "buck1",
    MinIOSecure:          false, 
}

cloudStorage, err := NewCloudStorageWithOption(context.Background(), false, "minio", "buck1", cloudStorageOpts)
if err != nil {
    return err
}
